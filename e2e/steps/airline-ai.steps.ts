...
Given("the administrator is on the login page", async function () { await this.page?.goto("http://localhost:3000/login"); });
...
When("a user selects an airline and approved fixed intent", async function () {});
